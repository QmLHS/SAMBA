...
otherAnmlNames <- c(
  ...
  "Entoprocta","Gastrotricha","Gnathostomulida","Hemichordata","Kinorhyncha",
  "Mollusca","Nematoda","Nematomorpha","Nemertea","Onychophora","Phoronida",
  "Placozoa","Platyhelminthes","Porifera","Priapulida","Rhombozoa","Rotifera",
...
cat("DONE: all the animals that aren't Chordates or Arthropods")
...
cat("DONE: all the fungi records")
...
cat("DONE: all the protist records")
...
cat("DONE: all the chordate records")
...
cat("DONE: all Arthropod records that are not of Insect Class")
...
cat("DONE: all Insect records for non-Col/Dip/Hym/Lep orders")
...
cat("DONE: all Coleopteran records")
...
cat("DONE: all Hymenopteran records")
...
cat("DONE: all Lepidoopteran records")